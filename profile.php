            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#activity" data-toggle="tab">Lap. Harian</a></li>
                        <li><a href="#settings" data-toggle="tab">Lap. Bulanan</a></li>
                        <li><a href="#laptahunan" data-toggle="tab">Lap. Tahunan</a></li>
                        <li><a href="#laplain" data-toggle="tab">Lap. Lain</a></li>
